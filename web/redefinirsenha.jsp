                        ...
                        <div class="col-lg-4 mx-auto">
                            ...
                            <div class="auto-form-wrapper">
                                ...
                                <form action="redefinirSenha" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="password" class="form-control" placeholder="Nova Senha" name="senhaNova1">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="mdi mdi-check-circle-outline"></i>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="password" class="form-control" placeholder="Confirmar Senha" name="senhaNova2">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="mdi mdi-check-circle-outline"></i>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary toolbar-item">RedefinirSenha</button>
                                    </div>
                                </form>
