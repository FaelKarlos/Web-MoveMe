...
<html lang="en">
    <head>
        ...
        <title>Recuperação de Senha - código</title>
        <!-- plugins:css -->
                ...
                <div class="content-wrapper d-flex align-items-center auth register-bg-1 theme-one">
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            <h2 class="text-center mb-4">Insira o código de recuperação</h2>
                            <div class="auto-form-wrapper">
                                <c:if test="${msg != null}">
                                    <p style="color: red">${msg}</p>
                                </c:if>
                                <form action="vericarCodigo" method="post">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" class="form-control" placeholder="Código" value="${usuario_atual.codRecuperacao}" name="codigo">
                                    ...
                                    <div class="form-group">
                                        <!--  <a href="redefinirsenha.jsp"><button type="button" class="btn btn-primary toolbar-item">Continuar</button></a> -->
                                    </div>
                                    <button type="submit" class="btn btn-primary toolbar-item">Continuar</button>
                                </form>
