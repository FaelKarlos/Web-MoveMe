 ...
 * @author Outros
 */
@WebServlet(name = "alterarAdmin", urlPatterns = {"/alterarAdmin"})
public class alterarAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nomeNovo.equals("")){
          ...
          request.setAttribute("msg", "Verifique se o campo nome não esta vazio no momento da alteração!");
       ...
       c.alterarAdministrador(novo);
         ...
         sessao.setAttribute("userLogado",c.getAdmistrador(id));
